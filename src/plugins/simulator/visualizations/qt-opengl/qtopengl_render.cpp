...
namespace argos {
   ...
   REGISTER_VISUALIZATION(CQTOpenGLRender,
                          ...
                          "XML, to 35mm.\n"
                          "You can also configure the camera to switch placement automatically according to\n"
                          "the current time step as shown in this example:\n"
                          "  <visualization>\n"
                          "    <qt-opengl>\n"
                          "      <camera>\n"
                          "        ...\n"
                          ...
                          "        <placement idx=\"2\" ... />\n"
                          "        ...\n"
                          "        <timeline idx=\"1\" step=\"50\" />\n"
                          "        <timeline idx=\"2\" step=\"100\" />\n"
                          "        <timeline idx=\"1\" step=\"200\" />\n"
                          "        <timeline idx=\"0\" step=\"500\" />\n"
                          "      </camera>\n"
                          "    </qt-opengl>\n"
                          "  </visualization>\n\n"
                          "The tag 'timeline' allows you to indicate which placement to activate\n"
                          "(attribute 'idx') at which time step (attribute 'step'). You can add as many\n"
                          "timeline items as you wish. You can specify them in any order, and they are\n"
                          "automatically sorted by time step.\n"
