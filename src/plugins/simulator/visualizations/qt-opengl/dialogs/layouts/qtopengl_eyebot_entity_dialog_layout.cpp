/**
 * @file <argos3/plugins/simulator/visualizations/qt-opengl/dialogs/layouts/qtopengl_eyebot_entity_dialog_layout.cpp>
 *
 * @author Ewout Merckx - <ewoutmerckx.pro@gmail.com>
 */

#include "qtopengl_eyebot_entity_dialog_layout.h"
...
namespace argos {
    ...
    CQTOpenGLEyeBotEntityDialogLayout::CQTOpenGLEyeBotEntityDialogLayout(QWidget* pc_parent_widget) 
    ...
    void CQTOpenGLEyeBotEntityDialogLayout::Init() 
    {
    ...
    void CQTOpenGLEyeBotEntityDialogLayout::CheckInput() 
    {
    ...
    CEntity& CQTOpenGLEyeBotEntityDialogLayout::GetEntity()
    {
        this->CheckInput();
        ...
        // create new entity
        CEyeBotEntity* cEyeBotEnt = new CEyeBotEntity(
            this->GetId(),
