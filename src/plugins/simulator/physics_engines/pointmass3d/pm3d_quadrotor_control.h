/**
 * @file <argos3/plugins/simulator/physics_engines/pointmass3d/pm3d_quadrotor_control.h>
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef PM3D_QUADROTORCONTROL_H
#define PM3D_QUADROTORCONTROL_H

namespace argos {
   class CPM3DEngine;
   class CPM3DQuadRotorControl;
   class CQuadRotorEntity;
}

#include <argos3/plugins/simulator/physics_engines/pointmass3d/pm3d_dynamicsmodel.h>
...
namespace argos {
   ...
   public:
      ...
      CPM3DQuadRotorControl(CPM3DEngine& c_engine,
