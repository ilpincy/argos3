...
class PxScene
{
	...
	*/
	...
	This method updates any changes in the simulation state to the scene representation
	used for queries. 
	...
	*/
	...
	/**
	\brief Tests overlap between a geometry and objects in the scene, returns results in a PxOverlapBuffer object
	or via a custom user callback implementation inheriting from PxOverlapCallback.
	
	\note Filtering: Overlap tests do not distinguish between touching and blocking hit types (see #PxQueryHitType).
