...
#include <argos3/plugins/simulator/physics_engines/physx/physx_dist/include/extensions/PxRepXSimpleType.h>
...
namespace physx
{
	...
	*/	
	...
	{
		return createRepXObject( inType, static_cast<const PxSerialObjectId>( reinterpret_cast<const size_t>( inType) ) );
	}
