...
#include <argos3/plugins/simulator/physics_engines/physx/physx_dist/include/foundation/PxMemory.h>
...
namespace physx
{
	...
	*/
	...
	\note PxVehicleUpdates is not thread-safe.  As a consequence, it must run sequentially and never concurrently with PxVehicleUpdateSingleVehicleAndStoreTelemetryData
