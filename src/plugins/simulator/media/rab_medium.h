...
namespace argos {
   ...
   public:
      ...
      */
       ...
       */
      const std::vector<CRABEquippedEntity*>& GetRABsCommunicatingWith(CRABEquippedEntity& c_entity) const;

   private:

      /** Defines the routing table */
      typedef std::map<CRABEquippedEntity*, std::vector<CRABEquippedEntity*> > TRoutingTable;
