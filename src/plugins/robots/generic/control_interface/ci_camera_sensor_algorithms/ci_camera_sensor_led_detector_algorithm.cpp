/**
 * @file <argos3/plugins/robots/generic/control_interface/ci_camera_sensor_algorithms/ci_camera_sensor_led_detector_algorithm.cpp>
 *
...
#ifdef ARGOS_WITH_LUA
   void CCI_CameraSensorLEDDetectorAlgorithm::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_CameraSensorLEDDetectorAlgorithm::ReadingsToLuaState(lua_State* pt_lua_state) {
