/**
 * @file <argos3/plugins/simulator/sensors/light_updated_default_sensor.h>
 *
 * @author Danesh Tarapore - <daneshtarapore@gmail.com>
 */

#ifndef LIGHT_UPDATED_DEFAULT_SENSOR_H
#define LIGHT_UPDATED_DEFAULT_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class CLightUpdatedDefaultSensor;
...
namespace argos {
   ...
   class CLightUpdatedDefaultSensor : public CSimulatedSensor,
                                      public CCI_LightUpdatedSensor {

   public:

      CLightUpdatedDefaultSensor();

      virtual ~CLightUpdatedDefaultSensor() {}
