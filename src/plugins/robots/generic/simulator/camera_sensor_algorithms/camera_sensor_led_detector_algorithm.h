/**
 * @file <argos3/plugins/robots/generic/simulator/camera_sensor_algorithms/camera_sensor_led_detector_algorithm.h>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#ifndef CAMERA_SENSOR_LED_DETECTOR_ALGORITHM_H
#define CAMERA_SENSOR_LED_DETECTOR_ALGORITHM_H
...
namespace argos {
    ...
    */
   class CCameraSensorLEDDetectorAlgorithm : public CCameraSensorSimulatedAlgorithm,
   ...
   public:
      ...
      private:
         ...
         CCameraSensorLEDDetectorAlgorithm& m_cAlgorithm;
      };
