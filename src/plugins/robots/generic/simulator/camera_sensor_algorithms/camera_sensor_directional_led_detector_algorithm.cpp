/**
 * @file <argos3/plugins/robots/generic/simulator/camera_sensor_algorithms/camera_sensor_directional_led_detector_algorithm.cpp>
 *
...
namespace argos {
   ...
   CCameraSensorDirectionalLEDDetectorAlgorithm::CCameraSensorDirectionalLEDDetectorAlgorithm() :
      m_bShowRays(false),
   ...
   void CCameraSensorDirectionalLEDDetectorAlgorithm::Init(TConfigurationNode& t_tree) {
      try {
         /* Parent class init */
         ...
         THROW_ARGOSEXCEPTION_NESTED("Error initializing the directional LED detector algorithm", ex);
      }
   }
   ...
   REGISTER_CAMERA_SENSOR_ALGORITHM(CCameraSensorDirectionalLEDDetectorAlgorithm,
