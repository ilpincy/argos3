...
namespace argos {
   ...
   public:
      ...
      static const Real OMNIDIRECTIONAL_CAMERA_DEFAULT_ELEVATION;
      static const CDegrees OMNIDIRECTIONAL_CAMERA_DEFAULT_APERTURE;
      ...
      CFootBotEntity(const std::string& str_id,
                     ...
                     const CRadians& c_omnicam_aperture = ToRadians(OMNIDIRECTIONAL_CAMERA_DEFAULT_APERTURE),
