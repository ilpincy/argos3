/**
 * @file <argos3/plugins/robots/drone/control_interface/ci_drone_rangefinders_sensor.cpp>
 *
 * @author Michael Allwright <allsey87@gmail.com>
 */

#include "ci_drone_rangefinders_sensor.h"
...
namespace argos {
   ...
   const CCI_DroneRangefindersSensor::SInterface::TVector& CCI_DroneRangefindersSensor::GetInterfaces() const {
...
#ifdef ARGOS_WITH_LUA
   void CCI_DroneRangefindersSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_DroneRangefindersSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
