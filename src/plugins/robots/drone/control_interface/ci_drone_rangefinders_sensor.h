/**
 * @file <argos3/plugins/robots/drone/control_interface/ci_drone_rangefinders_sensor.h>
 *
 * @author Michael Allwright <allsey87@gmail.com>
 */

#ifndef CCI_DRONE_RANGEFINDERS_SENSOR_H
#define CCI_DRONE_RANGEFINDERS_SENSOR_H

namespace argos {
   class CCI_DroneRangefindersSensor;
}
...
namespace argos {
   ...
   class CCI_DroneRangefindersSensor : public CCI_Sensor {
   ...
   public:
      ...
      virtual ~CCI_DroneRangefindersSensor() {}
