/**
 * @file <argos3/plugins/robots/eye-bot/control_interface/ci_eyebot_light_sensor.h>
 *
 * @brief This file provides the definition of the eyebot light sensor.
 *
 * This file provides the definition of the eyebot light sensor.
...
#ifndef CCI_EYEBOT_LIGHT_SENSOR_H
#define CCI_EYEBOT_LIGHT_SENSOR_H
