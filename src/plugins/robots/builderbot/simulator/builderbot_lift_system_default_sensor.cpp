...
namespace argos {
   ...
   REGISTER_SENSOR(CBuilderBotLiftSystemDefaultSensor,
                   ...
                   "The documentation for this sensor is \e]8;;https://github.com/ilpincy/argos3/blob/master/src/plugins/robots/builderbot/README.md#builderbot_lift_system\aavailable on Github\e]8;;\a.",
                   "Usable"
   );
